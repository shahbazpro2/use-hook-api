...
exports.allKeysExist = exports.excludeErrorKeys = exports.apiResStructure = exports.Axios = exports.cancelRequest = void 0;
                ...
                switch (_3.label) {
                    ...
                    case 2:
                        ...
                        if (((_l = err_1.response) === null || _l === void 0 ? void 0 : _l.status) === 500) {
                            ...
                            data_1 = { status: (_0 = err_1.response) === null || _0 === void 0 ? void 0 : _0.status, message: (0, objectToArray_js_1.default)({ obj: (_1 = err_1.response) === null || _1 === void 0 ? void 0 : _1.data, excludeErrorKeys: exports.excludeErrorKeys }) };
