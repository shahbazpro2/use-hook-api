                    ...
                    case 1:
                        ...
                        if ((0, exports.allKeysExist)(res.data, ["".concat(dataKey, "||data"), "".concat(errKey, "||message")]))
                            return [2 /*return*/, {
                                    ...
                                    message: (0, objectToArray_1.default)({ obj: ((_c = res.data) === null || _c === void 0 ? void 0 : _c[errKey]) || ((_d = res.data) === null || _d === void 0 ? void 0 : _d.message), excludeErrorKeys: excludeErrorKeys }),
                                    fullRes: res.data,
                                }];
                            ...
                            return [2 /*return*/, {
                                    ...
                                    status: res.status,
                                    data: res.data,
                                    message: (0, objectToArray_1.default)({ obj: ((_e = res.data) === null || _e === void 0 ? void 0 : _e[errKey]) || ((_f = res.data) === null || _f === void 0 ? void 0 : _f.message), excludeErrorKeys: excludeErrorKeys }),
                                    fullRes: res.data,
                                }];
                            ...
                            return [2 /*return*/, {
                                    ...
                                    message: (0, objectToArray_1.default)({ obj: ((_j = res.data) === null || _j === void 0 ? void 0 : _j[dataKey]) || ((_k = res.data) === null || _k === void 0 ? void 0 : _k.data), excludeErrorKeys: excludeErrorKeys }),
                                    fullRes: res.data,
                                }];
                        else
                            return [2 /*return*/, {
                                    ...
                                    status: res.status,
                                    data: res.data,
                                    message: (0, objectToArray_1.default)({ obj: res.data, excludeErrorKeys: excludeErrorKeys }),
                                    fullRes: res.data,
                                }];
                        return [3 /*break*/, 3];
                    case 2:
                        ...
                        if (((_l = err_1.response) === null || _l === void 0 ? void 0 : _l.status) === 500) {
                            ...
                            data_1 = {
                                ...
                                message: (0, objectToArray_1.default)({
                            ...
                            data_1 = {
                                ...
                                message: (0, objectToArray_1.default)({ obj: ((_x = (_w = err_1.response) === null || _w === void 0 ? void 0 : _w.data) === null || _x === void 0 ? void 0 : _x[dataKey]) || ((_z = (_y = err_1.response) === null || _y === void 0 ? void 0 : _y.data) === null || _z === void 0 ? void 0 : _z.data), excludeErrorKeys: excludeErrorKeys }),
                            };
                        else
                            data_1 = { status: (_0 = err_1.response) === null || _0 === void 0 ? void 0 : _0.status, message: (0, objectToArray_1.default)({ obj: (_1 = err_1.response) === null || _1 === void 0 ? void 0 : _1.data, excludeErrorKeys: excludeErrorKeys }) };
