                    ...
                    case 1:
                        ...
                        if (allKeysExist(res.data, ["".concat(dataKey, "||data"), "".concat(errKey, "||message")]))
                            return [2 /*return*/, {
                                    ...
                                    message: objectToArray(((_c = res.data) === null || _c === void 0 ? void 0 : _c[errKey]) || ((_d = res.data) === null || _d === void 0 ? void 0 : _d.message)),
                                    fullRes: res.data,
                                }];
                            ...
                            return [2 /*return*/, {
                                    ...
                                    status: res.status,
                                    data: res.data,
                                    message: objectToArray(((_e = res.data) === null || _e === void 0 ? void 0 : _e[errKey]) || ((_f = res.data) === null || _f === void 0 ? void 0 : _f.message)),
                                    fullRes: res.data,
                                }];
                            ...
                            return [2 /*return*/, {
                                    ...
                                    message: objectToArray(((_j = res.data) === null || _j === void 0 ? void 0 : _j[dataKey]) || ((_k = res.data) === null || _k === void 0 ? void 0 : _k.data)),
                                    fullRes: res.data,
                                }];
                        else
                    ...
                    case 2:
                        ...
                        if (((_l = err_1.response) === null || _l === void 0 ? void 0 : _l.status) === 500) {
                            ...
                            data_1 = {
                                ...
                                message: objectToArray(((_r = (_q = err_1.response) === null || _q === void 0 ? void 0 : _q.data) === null || _r === void 0 ? void 0 : _r[errKey]) || ((_t = (_s = err_1.response) === null || _s === void 0 ? void 0 : _s.data) === null || _t === void 0 ? void 0 : _t.message)),
                            };
                            ...
                            data_1 = {
                                ...
                                message: objectToArray(((_x = (_w = err_1.response) === null || _w === void 0 ? void 0 : _w.data) === null || _x === void 0 ? void 0 : _x[dataKey]) || ((_z = (_y = err_1.response) === null || _y === void 0 ? void 0 : _y.data) === null || _z === void 0 ? void 0 : _z.data)),
                            };
                        else
